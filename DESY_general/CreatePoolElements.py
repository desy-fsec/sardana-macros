...
class _create_controller(Macro):
    ...
    param_def = [
        ['ctrl_type', Type.String, None, 'Type of controller'],
...
class _create_element(Macro):
    ...
    param_def = [
        ...
        ['ctrl_name',  Type.String, None, 'Name of the controller for the element'],
...
class create_motor_controller(Macro):
    ...
    param_def = [
        ...
        ['root_device_name',  Type.String, None, 'Common name of the motors to be controlled']
    ]
...
class create_motor(Macro):
    """Create a motor"""
    param_def = [
        ['motor_name', Type.String, None, 'Name of the motor to create'],
        ['axis_number',  Type.Integer, None, 'Axis number of the motor'],
        ['ctrl_name',  Type.String, None, 'Name of the controller for this motor']
    ]
