...
'analz','aperx','aperz','bpm3x','bpm3z','bpm4x','bpm4z','bpm6x','bpm6z','bstopx','bstopz',  'centx',  'centy',  'cryodist',  'dettabpit',  'dettabx',  'dettaby',  'dettabz',  'dettabzb',  'dettabzf',  'diftabpit',  'diftabx',  'diftabxb',  'diftabxf',  'diftabyaw',  'diftabz',  'diftabzb',  'diftabzf',  'dmot1',  'dmot2',  'dmot3',  'dmot4',  'dmot5',  'E',  'fehg',  'feho',  'fevg',  'fevo',  'foilb1',  'foilb2',  'foilb3',  'foilb4',  'fshuz',  'fsm2z',  'hfmq', 'hfmde3','hfmbenb',  'hfmbenf',  'hfmpit',  'hfmx',  'hfmz',  'holderlength',  'kappa',  'lamopit',  'lamoroll',  'lamox',  'lamoz',  'omega', 'omegaenc', 'omegax',  'omegay',  'omegaz',  'phi',  'pitang',  'pitstroke',  's1d',  's1hg',  's1ho',  's1l',  's1r',  's1u',  's1vg',  's1vo',  's2d',  's2u',  's2vg',  's2vo',  's3hg',  's3ho',  's3l',  's3r',  's4hg',  's4ho',  's4vg',  's4vo',  'theta',  'vfmbenb',  'vfmbenf',  'vfmbenfb',  'vfmbenff',  'vfmDE3',  'vfmpit',  'vfmq',  'vfmroll',  'vfmx',  'vfmz',  'zoommot'
        ...
        varsvar = ['beamx','beamxa','beamxb','beamy','beamya','beamyb','detsamdis','detsamdisa','detsamdisb','MachineCurrent','oav_pixelsize_x','oav_pixelsize_y','pinlength','totalroicountsfluo','totalroicountsratio','totalroicountsscat','update_pixelsize_x','update_pixelsize_y','xprojfitcenterfromcenter','xprojfitfwhm','yprojfitcenterfromcenter','yprojfitfwhm']
        for var in varsvar:
           self.info(var)
           try:
