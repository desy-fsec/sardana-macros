...
if __name__ == '__main__':
    ...
    if len(sys.argv) <= 2:
	print '\nusage: xfmbenxNewtons2hs({''N'',''hs''}, force)\n'
    else:
	request  = str(sys.argv[1])
	force = float(sys.argv[2])

    print 'VFM'
    vfmbenb = vfmbenb_conversion(request, force)
    vfmbenf = vfmbenf_conversion(request, force)
    print 'vfmbenb(', force, ') => ', vfmbenb, request
    print 'vfmbenf(', force, ') => ', vfmbenf, request

    print 'HFM'
    hfmbenb = hfmbenb_conversion(request, force)
    hfmbenf = hfmbenf_conversion(request, force)
    print 'hfmbenb(', force, ') => ', hfmbenb, request
    print 'hfmbenf(', force, ') => ', hfmbenf, request


    print '\nHFM Force to elipse'
    E2, E3 = hfmelipse_conversion('Elipse', 278.45, 231.81)
    Fu, Fd = hfmelipse_conversion('Force', E2, E3)
    print E2, E3
    print Fu, Fd

    print 'HFM Elipse to Optics'
    q, DE3 = hfmoptic_conversion('Optics', E2, E3, 4.1, 24.785)
    E2, E3 = hfmoptic_conversion('Elipse', q, DE3, 4.1, 24.785)
    print q, DE3
    print E2, E3


    print '\nVFM Force to elipse'
#    E2v, E3v = vfmelipse_conversion('Elipse', 178.558, 130.277)
    E2v, E3v = vfmelipse_conversion('Elipse', 120, 120)
    Fuv, Fdv = vfmelipse_conversion('Force', E2v, E3v)
    print E2v, E3v
    print Fuv, Fdv

    print 'VFM Elipse to Optics'
    qv, DE3v = vfmoptic_conversion('Optics', E2v, E3v, 4.1, 22.8)
    E2v, E3v = vfmoptic_conversion('Elipse', qv, DE3v, 4.1, 22.8)
    print qv, DE3v
    print E2v, E3v
